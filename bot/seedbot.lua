...
function create_config( )
  ...
  config = {
	...
	"whitelist",
	"msg_checks",
	"mega_asli",--SuperGroup Plugin
	"bk",--talkative plugins
	"mame",--talkative plugins
	"chetori",--talkative plugins
	"ker"--talkative plugins
    },
    sudo_users = {Your Id},--Sudo users
    moderation = {data = 'data/moderation.json'},
    about_text = [[:| Seede Mage
]],
    help_text_realm = [[
Realm Commands:
...
💥 برای افزودن سازنده روبات به گروه استفاده کنند !invsudo صاحبان گروه میتونند از دستور 💥
